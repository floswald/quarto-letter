...
This is my recommendation for {{< var full >}}. {{< var first >}} is a great student. {{< var Pro >}} was always on time in class, even if {{< var pro >}} had to run.
